...
3. Clone this repository or copy the code from the provided `unit_converter.py` file.

4. Navigate to the directory where the `unit_converter.py` file is located.
